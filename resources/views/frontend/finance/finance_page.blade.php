...
@section('homepage')
 ...
 <section id="about" class="d-flex align-items-center">
  <div class="container" data-aos="zoom-out" data-aos-delay="100" align="center">
   <h1><span>Company</span> Finance</h1>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-center p-2" data-aos="fade-up" data-aos-delay="100">
     <div class="col-lg-10 image">
      <img src="{{ url('upload/finance_image/'.$finance->image) }}" class="img-fluid">
     </div>
    </div>

    <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
     <div class="col-lg-10">
      <h2 class="mt-5 mb-3 heading">{{ $finance->heading }}</h2>
      <span class="title">{{ $finance->title }}</span>
      <p class="text-justify">{{ $finance->discriptsion }}</p>
     </div>
    </div>

      @php
        $datas = json_decode($finance->sub_heading );
        $val   = json_decode($finance->sub_title);
        $val2  = json_decode($finance->sub_discriptsion);
      @endphp
