    ...
    <div class="row justify-content-center">
     <div class="col-8">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('FAQ.update',$editdata->id) }}" id="myForm" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
          ...
          @php
            $datas = json_decode($editdata->question);
            $val   = json_decode($editdata->anwser);
          @endphp
         ...
         @foreach($datas as $key => $edit)
          ...
          <div class="delete_whole_extra_add bg-light" id="delete_whole_extra_add" >
           ...
           <div class="form-group col-md-12">
            ...
            <input type="text" name="question[]" value="{{ $edit }}" class="form-control" placeholder="Enter Question">
           </div>

           <div class="form-group col-md-12">
            <label for="anwser"> Answer </label>
            <input type="text" name="anwser[]" class="form-control" value="{{ isset($val[$key]) ? $val[$key] : "" }}" placeholder="Enter answer">
           </div>
