         ...
         <form method="POST" action="{{ route('category.update',$editdata->id) }}" id="myForm" enctype="multipart/form-data">
          ...
          <div class="form-row">
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" name="title" class="form-control"  value="{{ $editdata->title }}" placeholder="Enter Designation">
           ...
           <div class="form-group col-md-6">
            <img id="showImage" src="{{!empty($editdata->image)?url('upload/category_image/'.$editdata->image):url('upload/No-image.jpg')}}"  style=" height:120px; border:1px solid #ccc;">
           </div>
