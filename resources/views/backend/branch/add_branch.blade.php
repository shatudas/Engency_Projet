    ...
    <div class="row justify-content-center">
     <div class="col-10 ">
      ...
      <div class="card">
        ...
        <div class="card-body">
         <form method="POST" action="{{ route('branch.store') }}" id="myForm" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" name="email" class="form-control" placeholder="Enter Compamy email">
            <font style="color:red">{{ ($errors->has('email'))?($errors->first('email')):'' }}</font>
           </div>

           <div class="form-group col-md-6">
            <label for="phone">Phone <span style="color:red;">*</span></label>
            <input type="text" name="phone" class="form-control" placeholder="Enter Compamy phone">
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" name="ending_time" class="form-control" placeholder="Ending Time">
