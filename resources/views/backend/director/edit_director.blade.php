     ...
     <div class="col-10 ">
      ...
      <div class="card">
        <div class="card-header">
         <h3> Update Director
         <a href="{{ route('director.view') }}" class=" btn btn-success btn-sm float-right"> <i class="fa fa-list"></i> User List </a>
        </h3>
        </div>
               
        <div class="card-body">
         <form method="POST" action="{{ route('director.update',$editdata->id) }}" id="myForm" enctype="multipart/form-data">
         @csrf
          <div class="form-row">
           ...
           <div class="form-group col-md-6">
            <img id="showImage" src="{{!empty($editdata->image)?url('upload/director_image/'.$editdata->image):url('upload/No-image.jpg')}}"  style=" height:120px; border:1px solid #ccc;">
           </div>
