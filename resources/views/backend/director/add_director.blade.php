     ...
     <div class="col-10 ">
      ...
      <div class="card">
        <div class="card-header">
         <h3> Add Director
          <a href="{{ route('director.view') }}" class=" btn btn-success btn-sm float-right"> <i class="fa fa-list"></i> Director List</a>
         </h3>
        </div>
               
        <div class="card-body">
         <form method="POST" action="{{ route('director.store') }}" id="myForm" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
