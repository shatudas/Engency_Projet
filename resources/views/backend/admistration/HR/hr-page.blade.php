 ...
 <div class="content-wrapper bg-white">
  ...
  <div class="content-header">
   <div class="container-fluid">
    <div class="row mb-2">
     <div class="col-sm-6">
      <h1 class="m-0"> Manage HR Administration </h1>
     </div>
     <div class="col-sm-6">
     ...
     <div class="row justify-content-center">
      <div class="col-10">
       <div class="card">
        ...
        <div class="card-body">
         <form method="POST" action="{{ route('hr.update',$editdata->id) }}" enctype="multipart/form-data" id="myForm">
           @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-12">
             <label for="title"> HR Detalis </label>
            ...
            <div class="form-group col-md-8" align="center">
             <img id="showImage" src="{{ !empty($editdata->image)?url('upload/hr_image/'.$editdata->image):url('upload/No-image.jpg') }}" style="width:200px; height:150px; margin-top:30px; border:1px solid #ccc;" align="center">
            </div>  
