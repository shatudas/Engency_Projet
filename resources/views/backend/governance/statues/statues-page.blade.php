 ...
 <div class="content-wrapper bg-white">
  ...
  <div class="content-header">
   <div class="container-fluid">
    <div class="row mb-2">
     <div class="col-sm-6">
      <h1 class="m-0"> Manage Statutes </h1>
     </div>
     <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
       <li class="breadcrumb-item"><a href="{{ route('home') }}"> Home </a></li>
       <li class="breadcrumb-item active"> Statutes of the Government </li>
      </ol>
     </div>
    </div>
   </div>
     ...
     <div class="col-10">
      <div class="card">
        ...
        <div class="card-header">
         <h3> Statutes of the Government </h3>
        </div>

        <div class="card-body">
         <form method="POST" action="{{ route('statutes.update',$editdata->id) }}" enctype="multipart/form-data" id="myForm">
           @csrf
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-12">
             <label for="title"> Statues Detalis </label>
             <textarea id="summernote" name="discriptsion" class="form-control" rows="5">
            ...
            <div class="form-group col-md-8" align="center">
             <img id="showImage" src="{{ !empty($editdata->image)?url('upload/statues_image/'.$editdata->image):url('upload/No-image.jpg') }}" style="width:200px; height:150px; margin-top:30px; border:1px solid #ccc;" align="center">
            </div>  

           </div>

         @php
          $datas = json_decode($editdata->sub_title);
          $val   = json_decode($editdata->sub_heading);
         ...
         @foreach($datas as $key => $edit)
          ...
          <div class="delete_whole_extra_add" id="delete_whole_extra_add">
           <div class="add_item">
            <div class="form-row">
              <div class="form-group col-md-6">
               <input type="text" name="sub_title[]" value="{{ $edit }}" class="form-control" placeholder="Enter Amount..">
              </div>

              <div class="form-group col-md-6">
              <input type="text" name="sub_heading[]" value="{{ isset($val[$key]) ? $val[$key] : "" }}" class="form-control" placeholder="Enter Amount..">
             </div>
    ...
    <div class="delete_whole_extra_add w-100" id="delete_whole_extra_add">
     <div class="form-row bg-none justify-content-center">
      ...
      <div class="form-group col-md-12">
       ...
       <textarea id="summernote" name="sub_discriptsion[]" class="form-control" rows="5"></textarea>
      </div>
