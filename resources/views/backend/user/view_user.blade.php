     ...
     <div class="col-12">
      <div class="card">
       ...
       <div class="card-header">
        <h3> User List
         <a href="{{route('user.add')}}" class=" btn btn-success btn-sm float-right">
           ...
           <tr>
            ...
            <td align="center">
              ...
              <small><a class="btn btn-warning btn-sm p-0 m-0 text-white"> Super Admin </a></small>
               @else
               <a title="Edit" href="{{ route('user.edit',$user->id) }}" class="btn btn-sm btn-primary mr-2" >
               <i class="fa fa-edit"></i>
               <a title="Delete" href="{{ route('user.delete',$user->id) }}" id="delete" class="btn btn-sm btn-danger">
